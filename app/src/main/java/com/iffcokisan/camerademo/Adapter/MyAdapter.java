    ...
    * */
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==TYPE_MOVIE){
            return new MovieHolder(inflater.inflate(R.layout.raw_items,parent,false));
        }else{
            return new LoadHolder(inflater.inflate(R.layout.raw_load,parent,false));
        }
    }
    ...
    class MovieHolder extends RecyclerView.ViewHolder{
        ...
        void bindData(MovieModel movieModel){
            ...
            tvRating.setText("Email Id : "+movieModel.rating);
        }
    }
